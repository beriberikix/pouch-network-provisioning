...
**iOS (Swift, planned)**
- Same shape: a `GoliothCertProvider` using Security/CryptoKit (P-256) + a CSR
  builder, `URLSession` for the REST calls, feeding the planned
  `provisionCredentials(...)` path.
